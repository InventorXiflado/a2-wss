...
(namespace?":"+namespace:"")+" - "+this.getTime()+":"+a));b.scrollTop=b.scrollHeight}catch(c){}};this.trace("---- new logger at "+location.href)}if(!b)this.trace=emptyFn}this.trace(a)}else{this._deferred.length===0&&easyXDM.whenReady(debug.flush,debug);this._deferred.push(a);this.log(a)}},getTracer:function(a){return function(b){debug.trace(a+": "+b)}}};debug.log("easyXDM present on '"+location.href);
