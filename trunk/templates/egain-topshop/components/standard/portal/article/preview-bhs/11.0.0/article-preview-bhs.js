        ...
        _onTopArticlesRetrieveSuccess : function(data) {
            ...
            */
			...
			if(articles.length==0){
				...
				this.topicModel.getChildTopics2({
					topicId : this.topicId,
					success : function(data){
						//alert("data " + data.topics.topicTree[0].topicTree[0]);
						//alert(this.$('.standard-portal-article-preview').length);
						var topics = {
								topics : data.topics.topicTree,
								childTopics : data.topics.topicTree[0].topicTree
							}
						$('.standard-portal-article-preview-bhs').append(this.compileTemplate('topic-preview', topics));
					},
					context : this
				});
			}
